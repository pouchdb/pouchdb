...
This release contains a database migration, this means when once you upgrade you will no longer be able to use previous versions of PouchDB on the same databases.
