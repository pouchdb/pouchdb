...
var PouchAdapter = function(storage) {
  ...
  this.replicate = {
    from: this.replicateFrom.bind(this),
    to: this.replicateTo.bind(this)
  }
}

module.exports = PouchAdapter;

PouchAdapter.prototype = {
  ...
  replicateFrom: function(dbname, opts, callback) {
    if (opts instanceof Function) {
      callback = opts;
      opts = {};
    }
    return Pouch.replicate(dbname, this, opts, callback);
  },

  replicateTo: function(dbname, opts, callback) {
    if (opts instanceof Function) {
      callback = opts;
      opts = {};
    }
    return Pouch.replicate(this, dbname, opts, callback);
  }
}
