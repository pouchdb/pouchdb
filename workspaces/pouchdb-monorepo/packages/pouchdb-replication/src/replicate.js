...
function replicate(src, target, opts, returnValue, result) {
  ...
  async function getChanges() {
    ...
    var changes = await src.changes(changesOpts)
      .on('change', onChange);
    changes(removeListener, removeListener);
    changes(onChangesComplete)
