...
describe('test.merge.js', function() {
  ...
  it('Merging a new_leaf doesnt return new_branch when branches exist', function() {
  ...
  it('Merging unstemmed recovers as much as possible without losing info', function() {
  ...
  it('winningRev returns the longest leaf', function() {
    ...
    winningRev({rev_tree: tree}).should.equal("3-93c3db16462f656f7172ccabd3cf6cd6");
  });
  ...
  it('winningRev returns the longest leaf again', function() {
    ...
    winningRev({rev_tree: tree}).should.equal("3-64a9842c6aea50bf24660378e496e853");
  });
  ...
  it('Merging a stem at a deeper level against paths at deeper levels.', function() {
