...
function getBuiltIn(reduceFunString) {
  if (reduceFunString.startsWith('_sum')) {
    return builtInReduce._sum;
  } else if (reduceFunString.startsWith('_count')) {
    return builtInReduce._count;
  } else if (reduceFunString.startsWith('_stats')) {
    return builtInReduce._stats;
  } else if (reduceFunString.startsWith('_')) {
