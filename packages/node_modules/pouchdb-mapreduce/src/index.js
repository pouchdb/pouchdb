...
function getBuiltIn(reduceFunString) {
  // PhantomJS does not have String.prototype.startsWith
  function startsWith(s, p) {
    return s.substring(0, p.length) === p;
  }
  if (startsWith(reduceFunString, '_sum')) {
    return builtInReduce._sum;
  } else if (startsWith(reduceFunString, '_count')) {
    return builtInReduce._count;
  } else if (startsWith(reduceFunString, '_stats')) {
