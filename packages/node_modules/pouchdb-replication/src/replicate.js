...
function replicate(src, target, opts, returnValue, result) {
  ...
  function getDiffs() {
    ...
    currentBatch.changes.forEach(function (change) {
      returnValue.emit('checkpoint', {"diffing": change});
  ...
  function startNextBatch() {
    ...
    returnValue.emit('checkpoint', {"startNextBatch": currentBatch.seq});
    getDiffs()
      .then(getBatchDocs)
      .then(writeDocs)
      .then(finishBatch)
  ...
  function onChange(change, pending, lastSeq) {
    ...
    returnValue.emit('checkpoint', {"pendingBatch": pendingBatch.seq});
    nextTick(function () {
