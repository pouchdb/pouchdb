...
function init(api, opts, callback) {
  ...
  api._changes = function (opts) {
    ...
    function onGetCursor(cursor) {
      ...
      function onGetWinningDoc(winningDoc) {
        ...
        if (filtered) {
          ...
          if (!process.env.POUCHDB_LITE && opts.attachments && opts.include_docs) {
    ...
    function fetchChanges() {
      ...
      if (process.env.POUCHDB_LITE && opts.attachments) {
    ...
    function onTxnComplete() {
      ...
      if (process.env.POUCHDB_LITE && !opts.continuous && opts.attachments) {
  ...
  if (process.env.POUCHDB_LITE) {
    // this is all we need assuming we don't handle migrations for pre-v5
...
IdbPouch.valid = function () {
  if (process.env.POUCHDB_LITE) {
    // if you're using pouchdb lite, you're on your own
    return true;
  } else {
