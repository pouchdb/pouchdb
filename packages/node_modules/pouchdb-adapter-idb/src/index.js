...
IdbPouch.valid = function () {
  ...
  // Safari > 10.1 has a good IDB implementation
  // this check is valid until Safari version 19.99
  // at which point I hope this is all refactoreed anyway
  var isSafariWithGoodIDB = isSafari && (
    /Version\/10.[1-9]{1,2}/.test(navigator.userAgent)
    ||
    /Version\/1[1-9].[0-9]{1,2}/.test(navigator.userAgent)
  )
