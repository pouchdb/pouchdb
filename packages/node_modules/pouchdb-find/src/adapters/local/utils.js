...
export function massageSort(sort) {
...
export function massageUseIndex(useIndex) {
  let cleanedUseIndex = [];
...
export function massageIndexDef(indexDef) {
...
export function filterInclusiveStart(rows, targetValue, index) {
...
export function reverseOptions(opts) {
...
export function validateSort(requestDef, index) {
...
export function validateFindRequest(requestDef) {
