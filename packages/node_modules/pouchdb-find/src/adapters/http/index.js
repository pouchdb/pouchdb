...
export function createIndex(db, requestDef, callback) {
  dbFetch(db, '_index', {
    method: 'POST',
...
export function find(db, requestDef, callback) {
...
export function explain(db, requestDef, callback) {
  dbFetch(db, '_explain', {
    method: 'POST',
    body: requestDef
  })
...
export function getIndexes(db, callback) {
...
export function deleteIndex(db, indexDef, callback) {
