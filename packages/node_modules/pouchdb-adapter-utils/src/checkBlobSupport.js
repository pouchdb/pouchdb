...
//
// Webkit error: DataCloneError: Failed to store record in an IDBObjectStore: BlobURLs are not yet supported.
//
...
function checkBlobSupport(txn, store, docIdOrCreateDoc) {
  return new Promise(function (resolve) {
    ...
    if (typeof docIdOrCreateDoc === 'function') {
      ...
      console.log('PUTTING DOC:', JSON.stringify(doc));
      req = txn.objectStore(store).put(doc);
    } else {
      const docId = docIdOrCreateDoc;
      console.log('PUTTING BLOB DIRECTLY:', docId);
      req = txn.objectStore(store).put(blob, docId);
    }

    req.onsuccess = function () {
      console.log('checkBlobSupport()', 'success');
      var matchedChrome = navigator.userAgent.match(/Chrome\/(\d+)/);
      var matchedEdge = navigator.userAgent.match(/Edge\//);
      console.log('checkBlobSupport()', 'success', matchedChrome, matchedEdge);
    ...
    req.onerror = txn.onabort = function (e) {
      console.log('checkBlobSupport()', 'error', e);
    ...
    console.log('checkBlobSupport()', 'err:', err.message);
