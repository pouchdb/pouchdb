...
function doPreprocessAttachments(docInfos, blobType, callback) {
...
function skipPreprocessingAttachments(callback) {
  callback();
}

var preprocessAttachments;
if (process.env.POUCHDB_LITE) {
  preprocessAttachments = skipPreprocessingAttachments;
} else {
  preprocessAttachments = doPreprocessAttachments;
}
