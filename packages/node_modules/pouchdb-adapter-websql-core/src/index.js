...
function WebSqlPouch(opts, callback) {
  ...
  function onGetVersion(tx, dbVersion) {
    if (dbVersion === 0) {
      ...
      var meta = 'CREATE TABLE IF NOT EXISTS ' + META_STORE +
        ' (dbid, db_version INTEGER, doc_count INTEGER)';
        ...
        tx.executeSql(seq, [], function () {
          ...
          tx.executeSql(meta, [], function () {
            ...
            var initSeq = 'INSERT INTO ' + META_STORE +
              ' (db_version, dbid, doc_count) VALUES (?,?,?)';
            instanceId = uuid();
            var initSeqArgs = [ADAPTER_VERSION, instanceId, 0];
      ...
      var setupDone = function () {
        ...
        // update and set the doc_count
        countDocsAndCache(tx);
      };
  ...
  function countDocs(tx, cb) {
    var sql = 'SELECT doc_count FROM ' + META_STORE;
    tx.executeSql(sql, [], function (tx, res) {
      cb(res.rows.item(0).doc_count);
    });
  }

  function countDocsAndCache(tx) {
    ...
    var sql = 'UPDATE ' + META_STORE + ' SET doc_count = (' +
      subquery + ')';
    tx.executeSql(sql, [], null, function () {
      // this column may not exist in PouchDB <=6.1.1
      tx.executeSql('ALTER TABLE ' + META_STORE +
        ' ADD COLUMN doc_count INTEGER', [], function () {
        countDocsAndCache(tx);
      });
