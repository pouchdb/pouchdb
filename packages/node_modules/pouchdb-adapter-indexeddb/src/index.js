...
function IndexeddbPouch(dbOpts, callback) {
  ...
  api._getRevisionTree = $t(getRevisionTree, [META_LOCAL_STORE, DOC_STORE]); // TODO as per get(), we could check and only open correct store here // TODO TODO may only be relevant for non-local docs anyway
