...
function IndexeddbPouch(dbOpts, callback) {
  ...
  api._get = $t(get, [META_LOCAL_STORE, DOC_STORE]); // TODO can be more selective with which store we're opening here
  ...
  api._getRevisionTree = $t(getRevisionTree, [META_LOCAL_STORE, DOC_STORE]); // TODO as per get(), we could check and only open correct store here
