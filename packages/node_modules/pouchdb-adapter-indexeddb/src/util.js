...
import { createError, IDB_ERROR, MISSING_DOC } from 'pouchdb-errors';
import {
...
function getDocFn(docStore) {
  return function (txn, id, opts, callback) {
    if (txn.error) {
