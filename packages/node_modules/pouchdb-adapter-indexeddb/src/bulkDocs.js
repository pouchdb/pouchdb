...
export default function (api, req, opts, metadata, dbOpts, idbChanges, callback) {
  ...
  function preProcessAttachment(attachment) {
    ...
    console.log('preProcessAttachment()', JSON.stringify({
      data_type: typeof attachment.data,
      attachment,
    }));

    var binData;
    if (typeof attachment.data === 'string') {
      console.log('preProcessAttachment()', 'string');
      try {
      ...
      console.log('preProcessAttachment()', attachment.data);
    ...
    console.log('preProcessAttachment()', 'binData:', binData);
    console.log('preProcessAttachment()', 'attachment.data:', attachment.data);
