...
function maintainNativeIndexes(openReq, reject) {
  ...
  ddocsReq.onsuccess = function (e) {
    ...
    var systemIndexNames = ['seq','_isDeleted_id'];
...
function openDatabase(openDatabases, api, opts, resolve, reject) {
  ...
  openReq.onsuccess = function (e) {
    ...
    var metadata = {id: META_LOCAL_STORE};
    var txn = idb.transaction([META_LOCAL_STORE], 'readwrite');

    txn.oncomplete = function () {
      resolve({idb, metadata});
    };

    var metaStore = txn.objectStore(META_LOCAL_STORE);
