...
function openDatabase(openDatabases, api, opts, resolve, reject) {
  ...
  openReq.onsuccess = function (e) {
    ...
    const blobSupportPromise = checkBlobSupport(txn, META_STORE, 'blob-support');

    txn.oncomplete = function () {
      blobSupportPromise.then(blobSupport => {
        resolve({idb: idb, metadata: metadata, blobSupport: blobSupport});
      });
    };
