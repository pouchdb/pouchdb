...
function HttpPouch(opts, callback) {
  ...
  api.get = utils.adapterFun('get', function (id, opts, callback) {
    ...
    // If it exists, add the opts.atts_since value to the list of parameters.
    if (opts.atts_since) {
      if (opts.atts_since) {
        opts.atts_since = JSON.stringify(opts.atts_since);
      }
      params.push('atts_since=' + opts.atts_since);
    }
