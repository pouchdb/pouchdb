...
export default {
  openTransactionSafely: openTransactionSafely,
  taskQueue: taskQueue,
  compactRevs: compactRevs,
  postProcessAttachments: postProcessAttachments,
  fetchAttachmentsIfNecessary: fetchAttachmentsIfNecessary,
  readBlobData: readBlobData,
  applyNext: applyNext,
