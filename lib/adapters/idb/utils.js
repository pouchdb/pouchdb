...
exports.hasGetAll = function (store) {
  return store.getAll || store.mozGetAll;
};

exports.getAll = function (store, range, count) {
  if (store.getAll) {
    return store.getAll(range, count);
  }
  return store.mozGetAll(range, count);
};