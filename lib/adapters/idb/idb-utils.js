...
// sparse array to array of ints
exports.encodeWinningSeqs = function (winningSeqs) {
  var objectToStore = [];
  winningSeqs.forEach(function (_, i) {
    objectToStore.push(i);
  });
  return objectToStore;
};

// array of ints to sparse array
exports.decodeWinningSeqs = function (storedObject) {
  var arr = [];
  storedObject.forEach(function (i) {
    arr[i] = true;
  });
  return arr;
};
