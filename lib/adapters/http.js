...
function HttpPouch(opts, callback) {
  ...
  api.allDocs = utils.adapterFun('allDocs', function (opts, callback) {
    ...
    if (typeof opts.keys !== 'undefined') {
      ...
      //in its http request, so it will cause download all the docs of database again and again. 
      //Delete those workaround codes to follow couchdb's querying options.
