...
function HttpPouch(opts, callback) {
  ...
  api.get = utils.adapterFun('get', function (id, opts, callback) {
    ...
    // If it exists, add the opts.deleted_conflicts value to the list of parameters.
    // If deleted_conflicts=true then the resulting JSON will include the field
    // _deleted_conflicts containing all the deleted conflicting revisions.
    if (opts.deleted_conflicts) {
      params.push('deleted_conflicts=' + opts.deleted_conflicts);
    }
