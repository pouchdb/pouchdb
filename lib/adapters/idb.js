...
if (typeof window !== 'undefined' && !window.fakeConsole) { window.fakeConsole = []; }
...
function IdbPouch(opts, callback) {
  ...
  if (window) {
    window.fakeConsole.push('Making db ' + name);
  }
  ...
  api._bulkDocs = function idb_bulkDocs(req, opts, callback) {
    ...
    function writeDoc(docInfo, callback) {
      ...
      function finish() {
        ...
        if (window) {
          window.fakeConsole.push('Generated id: ' + docInfo.data._doc_id_rev);
        }
