      ...
      try {
        ...
        txn.oncomplete = function () {
          ...
          getBlobReq.onsuccess = function (e) {
            ...
            // Make sure only once ajax request is fired
            // for blob support detection
            if (blobSupportPromise === null) {
            ...
            blobSupportPromise.then(function (ajaxCheck) {
              blobSupport = ajaxCheck;
              checkSetupComplete();
            });
          };
        };
