...
function PouchDB(name, opts, callback) {
  ...
  var promise = new Promise(function (fulfill, reject) {
    ...
    // dicts representing currently active replication processes,
    // of type 'replication source/target' -> 'returned promise'.
    self.active_replications_from = {};
    self.active_replications_to = {};
    ...
    self.replicate.from = function (url, opts, callback) {
      ...
      if(!self.active_replications_from[url] || self.active_replications_from[url].ended) {
        self.active_replications_from[url] = PouchDB.replicate(url, self, opts, callback);
      }
      return self.active_replications_from[url];
    };
    ...
    self.replicate.to = function (url, opts, callback) {
      ...
      if(!self.active_replications_to[url] || self.active_replications_to[url].ended) {
        self.active_replications_to[url] = PouchDB.replicate(self, url, opts, callback);
      }
      return self.active_replications_to[url];
    };
