...
exports.onceSafely = function onceSafely(emitter, event, key, listener) {
  emitter.listeners(event).forEach(function (otherListener) {
    if (otherListener._key === key) {
...
exports.onSafely = function onceSafely(emitter, event, key, listener) {
  emitter.listeners(event).forEach(function (otherListener) {
    if (otherListener._key === key) {
      emitter.removeListener(event, otherListener);
    }
