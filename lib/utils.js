...
var binaryUtils = require('pouchdb-binary-util');
exports.createBlob = binaryUtils.createBlob;
exports.readAsArrayBuffer = binaryUtils.readAsArrayBuffer;
exports.readAsBinaryString = binaryUtils.readAsBinaryString;
exports.arrayBufferToBinaryString = binaryUtils.arrayBufferToBinaryString;
exports.fixBinary = function (bin) {
  if (!process.browser) {
    // don't need to do this in Node
    return bin;
  }
  return binaryUtils.binaryStringToArrayBuffer(bin);
};
