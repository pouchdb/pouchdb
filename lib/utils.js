...
Changes.prototype.addPouchListener = function (dbName, id, db, opts) {
...
Changes.prototype.removePouchListener = function (dbName, id) {
  if (!(id in this.listeners)) {
    return;
  }
  this.removeListener(dbName, this.listeners[id]);
};
