...
exports.updateDoc = function (prev, docInfo, results, i, cb, write, newEdits) {
...
// for bulkDocs, to contain PouchErrors instead of normal JSON objects.
exports.massageArrayResponse = function (obj) {
  return obj.map(function (v) {
    var obj;
    if (v.ok) {
      return v;
    } else if (v.error && v.error === 'conflict') {
      return errors.conflict(v.id);
