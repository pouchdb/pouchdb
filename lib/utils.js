...
exports.updateDoc = function updateDoc(prev, docInfo, results,
  ...
  var delta = 0;
  if (newEdits || oldRev !== winningRev) {
    console.log('----');
    console.log('oldRev', oldRev);
    console.log('winningRev', winningRev);
    console.log('previouslyDeleted', previouslyDeleted);
    console.log('oldDeleted', oldDeleted);
    console.log('deleted', deleted);
    console.log('docInfo.metadata.deleted', !!docInfo.metadata.deleted);
    ...
    delta = (oldDeleted === deleted) ? 0 :
        oldDeleted < deleted ? -1 : 1;
  }
