...
AbstractPouchDB.prototype.post = utils.adapterFun('post',
...
AbstractPouchDB.prototype.putAttachment = utils.adapterFun('putAttachment',
  function (docId, attachmentId, rev, blob, type, callback) {
    var api = this;
...
AbstractPouchDB.prototype.removeAttachment =
  utils.adapterFun('removeAttachment',
...
AbstractPouchDB.prototype.remove = utils.adapterFun('remove',
  function (doc, opts, callback) {
    if (typeof opts === 'function') {
      callback = opts;
      opts = {};
...
AbstractPouchDB.prototype.revsDiff = utils.adapterFun('revsDiff',
...
AbstractPouchDB.prototype.compactDocument =
  function (docId, max_height, callback) {
    ...
    this._getRevisionTree(docId, function (err, rev_tree) {
      ...
      merge.traverseRevTree(rev_tree,
...
// compaction
AbstractPouchDB.prototype.compact = utils.adapterFun('compact',
...
/* Begin api wrappers. Specific functionality to storage belongs in 
   the _[method] */
AbstractPouchDB.prototype.get = utils.adapterFun('get',
  function (id, opts, callback) {
    if (typeof opts === 'function') {
      callback = opts;
      opts = {};
    }
    ...
    return this._get(id, opts, function (err, result) {
      ...
      if (opts.attachments && doc._attachments) {
        ...
        Object.keys(attachments).forEach(function (key) {
          this._getAttachment(attachments[key], {encode: true, ctx: ctx},
            function (err, data) {
...
AbstractPouchDB.prototype.getAttachment = utils.adapterFun('getAttachment',
...
AbstractPouchDB.prototype.allDocs = utils.adapterFun('allDocs',
  function (opts, callback) {
    if (typeof opts === 'function') {
      callback = opts;
      opts = {};
