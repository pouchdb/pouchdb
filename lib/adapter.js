...
AbstractPouchDB.prototype.createIndex =
  utils.adapterFun('createIndex', function (indexName, indexer, callback) {
    this._createIndex(indexName, indexer, callback);
});

AbstractPouchDB.prototype.removeIndex =
  utils.adapterFun('removeIndex', function (indexName, callback) {
    process.nextTick(function () {
      callback();
    });
  });
