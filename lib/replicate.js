...
var KEY_ERROR = 0;
var KEY_COMPLETE = 1;
var KEY_COMPLETE_REPLICATION = 2;
...
function replicate(repId, src, target, opts, returnValue, result) {
  ...
  oncePerKey(returnValue, 'cancel', KEY_COMPLETE_REPLICATION,
    completeReplication);
  ...
  if (typeof opts.complete === 'function') {
    oncePerKey(returnValue, 'error', KEY_ERROR, opts.complete);
    oncePerKey(returnValue, 'complete', KEY_COMPLETE, function (result) {
