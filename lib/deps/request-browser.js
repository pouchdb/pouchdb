...
module.exports = function(options, callback) {
  // in Chromium 41, XMLHttpRequest is an object instead of a function, so
  // just testing for undefined doesn't work.
  if (typeof XMLHttpRequest === 'function' || options.xhr) {
